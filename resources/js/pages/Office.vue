      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="/images/headers/screening.jpg"
              class="d-block w-100"
              ...
              <div class="row">
                <div class="col-md-8 mx-auto">
                  ...
                  >
                    ...
                    <p class="text-dark mb-0">We’re passionate about our team, travel, being active and our guests.  We’re always looking for creative, like-minded people to join our team.</p>
                  </div>
                </div>
              </div>
            </div>
